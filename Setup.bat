...
CALL :Download https://github.com/git-for-windows/git/releases/download/v2.15.1.windows.2/Git-2.15.1.2-64-bit.exe Git-2.15.1.2-64-bit.exe
...
ECHO Install Git
Git-2.15.1.2-64-bit.exe /LOADINF="git_install.inf"
